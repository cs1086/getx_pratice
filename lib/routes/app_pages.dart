...
class AppPages{
  static const initPage=AppRoutes.I18NTestPage;//通常首頁都是routes的最上層頁面，如果放children內的頁面會報錯，children下的路徑前面要加上上層頁面的路徑例如底下所有children的路徑前面都要再加上AppRoutes.IndexPage，所以會變成/IndexPage/xxxPage
  static final routes=[GetPage(name: AppRoutes.I18NTestPage, page: ()=>I18NTestPage(),binding: AppBindings(),children:[
